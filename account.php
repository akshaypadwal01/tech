...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="feedback.php"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>&nbsp;Feedback</a></li></ul>
      </ul>
...
echo "<h4 class='text-center' style='color: red;'>All the best !!!</h4>";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Akshay Ramdas Padwal" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Akshay Padwal</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919975274620</h4>
		<h4 style="font-family:'typo' ">akshayp8801@gmail.com</h4>
		<h4 style="font-family:'typo' ">Annasaheb Magar College , Hadapsar</h4></div></div>
		</p>
      </div>
